...
{
    class CitizenHelper : MonoBehaviour
    {
        ...
        public int GetBaseIncome(ItemClass.Level level, ItemClass.Zone zone)
        {
            switch (zone){
        ...
        internal void GetIncome(ushort buildingID, Building buildingData, ref int income, ref int tourists)
        {
            ...
            int baseIncome = GetBaseIncome(buildingData.Info.m_class.m_level, zone);
