...
{
    public class WBOfficeBuildingAI8 : OfficeBuildingAI
    {
        ...
        protected override void SimulationStepActive(ushort buildingID, ref Building buildingData, ref Building.Frame frameData)
        {
            ...
            else if (buildingData.m_fireIntensity == 0)
            {
                ...
                int percentage = 100;
                if (buildingData.m_electricityProblemTimer >= 1 || buildingData.m_waterProblemTimer >= 1 || buildingData.m_waterProblemTimer >= 1 || buildingData.m_garbageBuffer > 60000 || buildingData.m_outgoingProblemTimer >= 128)
                {
                    percentage = 0;
                }
